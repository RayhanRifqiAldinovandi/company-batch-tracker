...
const CardPpic = () => {
  const { dataMinor, department, userType, totalDataPpicMinor, isBatchTrackerOpen, setIsBatchTrackerOpen, selectedBatch, handleIconClick, handleSendButtonClick } = useContext(LiveTrackingContext);
  return (
    <>
