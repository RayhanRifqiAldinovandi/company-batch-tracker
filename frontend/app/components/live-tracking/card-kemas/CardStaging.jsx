...
import ModalQueueKemas from "../../modal/ModalQueueKemas";
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center">
              <div className="flex flex-col items-center">
                ...
                {/* Total */}
                <h2 className="bg-[#C5DFF8] w-6 h-6 ml-2 pl-1.5 text-[#3559E0] font-bold rounded-xl">{totalDataStagingKemas}</h2>
              </div>
              <div className="ml-4">
